...
//     vendor.referralLink = `${config.app_url}/register?ref=${vendor.referralCode}`;
//     await vendor.save();
//   }
...
//   const link =
//     vendor.referralLink ||
//     `${config.app_url}/register?ref=${vendor.referralCode}`;
...
//     from: `"${vendor.businessName}" <${config.email_user}>`,
//     to: recipientEmail,
//     subject: `${vendor.businessName} invited you to join!`,
//     html: `
...
// // ✅ 3. Dashboard stats (UI design অনুযায়ী)
...
//   // 1 point = $2.50 (customize করো)
//   const worthEquivalent = (totalPoints * 2.5).toFixed(2);

//   // Transaction history (UI table এর জন্য)
...
//     transactionId: `#REF-${String(i + 1).padStart(4, '0')}`,
...
// const awardReferralPoint = async (userId: Types.ObjectId) => {
//   const referral = await Referral.findOne({
//     referredUserId: userId,
//     status: 'pending',
//   });

//   if (!referral) return; // referral নেই — skip

//   // Referral complete করো
//   referral.status = 'completed';
//   referral.completedAt = new Date();
//   await referral.save();

//   // Vendor এর point বাড়াও
